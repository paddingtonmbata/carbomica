...
ut.calc_emissions_all(results_optimized,start_year,facility_code,file_name='emissions_optimized_{}'.format(facility_code))
ut.calc_allocation(results_optimized,file_name='allocation_optimized_{}'.format(facility_code)) # allocation
ut.write_alloc_excel(progset, results_optimized, start_year,file_name='results/optimized_allocation_coverage.xlsx')
